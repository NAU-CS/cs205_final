...
#iterate over columns 6 and 7, sum their respective values, and print their averages, along with counting and printing the total pokemon
awk 'BEGIN{x = 0} {x++} {hpCount = hpCount + $6} {atkCount = atkCount + $7} END {print "Total Pokemon: " x "\nAvg. HP:" (hpCount / (x-1)) "\nAvg. Attack: " (atkCount / (x-1))}'
